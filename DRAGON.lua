...
if res ~= 200 then
print('\27[0;31m𖠕━┅┅┄T R E V O R┄┉┉━𖠕\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𖠕━┅┅┄T R E V O R┄┉┉━𖠕\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𖠕━┅┅┄T R E V O R┄┉┉━𖠕 ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
print([[
  ...
  تـــريــــــفــور يرحــــب بــكـم      
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/trevor462002/Trevor/tree/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,837576238,1801776653,1764999383,1767369613,1792681561,1892231097}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 TREVOR 𓏴   𓆪.")  
...
os.execute('wget https://github.com/trevor462002/Trevor/blob/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'✧︙ تم تحديث السورس \n✧︙ لديك اخر اصدار لسورس تريفور\n✧︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == '𖠕━┅┅┄T R E V O R┄┉┉━𖠕' and DevSoFi(msg) then
...
{{text = '𖠕━┅┅┄T R E V O R┄┉┉━𖠕', url="t.me/trevor_0"}}, 
} 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✧︙ اصدار سورس تريفور \n✧︙ الاصدار »{ v 1.6 }')
end
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/trevor462002/Trevor/blob/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'✧︙ تم تحديث السورس \n✧︙ لديك اخر اصدار لسورس تريفور\n✧︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
...
╭──── ● ☆ ● ────╮
☆
[𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆   ](t.me/trevor_0)
[TREVOR 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆    ](t.me/trevor_0)
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' T R E V O R ', url="https://t.me/trrevor"},{text = 'F R 3 O N', url="https://t.me/Fr3on1"}},  
  {{text = ' G A M B O L ',url="t.me/G8_00"}},
{{text = 'SOURCE trevor" ₉₀ | ₁₂.₀₀ ᴬᴹ', url="t.me/trevor_0"}},  
}  
local msg_id = msg.id_/2097152/0.5  
...
function(arg,data) 
usertext = '\n ✧ العضو ✧ ['..data.first_name_..'](t.me/'..(data.username_ or 'TREVOR')..')'
...
usertext = '\n ✧ العضو ✧ ['..result.title_..'](t.me/'..(username or 'TREVOR')..')'
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/trevor462002/Trevor/blob/main/DRAGON.lua")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/trevor462002/Trevor/tree/main/File_Bot/"..file)
if res == 200 then
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع تـــــــريفور") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع تـــــــريفور @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع تـــــــريفور @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"℘︙ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^رفع تـــــــريفور (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع تـــــــريفور (%d+)$")
...
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 TREVOR 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
...
'\n𖤛︙  علامة ال {🔓} تعني مفعل'..
'\n𖤛︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 TREVOR ??   𓆪ـــــــــــــــــــــ≫ٴ'..
'\n'..'𖤛︙  امر صيح » { '..kickme..
...
' }\n'..'𖤛︙  الرفع » { '..setadd..
' }\n'..'𖤛︙  الحظر » { '..banm..' }\n\nٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 TREVOR 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n𖤛︙ قناة سورس الوون ↓\n [ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 TREVOR 𓏴   𓆪.](t.me/SOURCE_SYRIA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀  TREVOR.',url="t.me/trevor_0"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس تريفور يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تريفور').." غادر" or text == 'بوت غادر' then  
...
*𖠕━┅┅┄T R E V O R┄┉┉━𖠕*
➫ .[ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 TREVOR 𓏴   𓆪. ](t.me/trevor_0)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'TREVOR 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/trevor_0"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'𖠕━┅┅┄T R E V O R┄┉┉━𖠕\n℘︙ ➫ .[ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 TREVOR 𓏴   𓆪. ](t.me/trevor_0)➤ ')
end
...
🍁صورتي 
𖠕━┅┅┄T R E V O R┄┉┉━𖠕
[🍁𖠕━┅┅┄T R E V O R┄┉┉━𖠕 ⚡️](t.me/trevor_0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🗯️التاريخ
𖠕━┅┅┄T R E V O R┄┉┉━𖠕
[🗯️ 𖠕━┅┅┄T R E V O R┄┉┉━𖠕 🗯️](t.me/trevor_0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'تريفور' or text == 'مبرمج السورس' or text == 'المـبرمج تريفور' then  
local Text = [[  
✧ مــبـرمج الســورس  ✧
]]  
keyboard = {}   
...
if text == 'شهد' or text == 'مكفهر' or text == 'مرات بقدونس' then
local Text = [[
𓆩 روح قلبي داد ??
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' مرات بقدونس ✧',url="t.me/mokfher"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'خالد' or text == 'اخو بقدونس' then  
local Text = [[  
✧ اقمــد مـن القمـدان يبرو✧
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧اخو بقدونس✧',url="t.me/khaled_azoz"}},  
...
if text == 'فرعون' or text == 'فوزي' then  
local Text = [[  
𖤛اقمـد من القمـدان يروحي 𖤛
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𖤛صّآحًبً آلَتٌلَيَ يَقُلَبًمًکْ𖤛',url="t.me/Fr3on1"}},  
...
if text == 'عمر' or text == 'السوبكي' then  
local Text = [[  
✧ اقـــمــــد مــن الـــقــمــدان يـــآروحـــي ✧
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧مغني السورس✧',url="t.me/Time_is_mone_y"}},  
...
if text == 'روما' or text == 'مريم' then  
local Text = [[  
✧اخت مكفهر✧
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧برنسيس✧',url="t.me/"}},  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ مــبـرمـج الســورس ★ 𓌺',url="t.me/trrevor"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'العاب' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  

...
sudo_users = {SUDO,837576238,1764999383,837576238,1876906792}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'تريفور'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ¹𝙏𝙍𝙀𝙑𝙊𝙍¹")  
...
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس تريفور { s: 6.7}')
end
if text == 'تريفور مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV Devid](t.me/trrevor)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽T R E V O R₎ ✤ ', url="t.me/trrevor"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖣘⁽T R E V O R₎𖣘', url="t.me/trrevor"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽F R 3 O N₎ ✤ ',url="t.me/Fr3on1"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 T R E V O R¹˼ 𓌺 ',url="t.me/trrevor"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/trrevor&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 F R 3 O N¹˼ 𓌺 ',url="t.me/Fr3on1"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/trrevor&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
local Text = [[
◍🌖   اهلا بك في سورس تريفور الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني   @trrevor  🐾
...
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/trrevor"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/Fr3on1"}},
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ', url="t.me/@Fr3on1"}},
{{text = '   ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌  ', url="t.me/trevor_0"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/trevor_0/522&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = '𖣘⁽T R E V O R₎𖣘', url="http://t.me/trrevor"}},
}
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
local Text = [[
 ◉   اهلا بك في سورس تريفور الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني   ◉ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽T R E V O R₎ 𖣘 ',url="t.me/trrevor"}},
{{text = '  ❨ TＷＡＳＯＬ ◉  ❩ ',url="t.me/trrevor"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽𝙏 𝙍 𝙀 𝙑 𝙊 𝙍₎ 𖣘', url="t.me/trrevor"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب تريفور' or text == 'العاب مطوره' or text == 'العاب' or text == 'العاب متطوره' then  
local Text = [[  
...
if tonumber(result.sender_user_id_) == tonumber(837576238) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج تريفور عام")
return false 
end
...
if result.id_ == tonumber(837576238) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج تريفور عام \n")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(837576238) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع كتم مبرمج تريفور عام")
return false 
end
...
if result.id_ == tonumber(837576238) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك كتم مبرمج تريفور عام \n")
return false 
end
if result.id_ == tonumber(1764999383) then
...
if text == "فحص البوت" or text == "تيست" and Manager(msg) then
local chek = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..bot_id)
local getInfo = JSON.decode(chek)

...
if res ~= 200 then
print('\27[0;31m⩹━━━━⊶❲¹𝙏𝙍𝙀𝙑𝙊𝙍¹❳⊷━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⩹━━━━⊶❲¹𝙏𝙍𝙀𝙑𝙊𝙍¹❳⊷━━━━⩺\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⩹━━━━⊶❲¹𝙏𝙍𝙀𝙑𝙊𝙍¹❳⊷━━━━⩺ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
▄██▄▄█▀▀▀─────▀──▄██▄▄█
   ...
   •°o.Oتہـــريہــفہـــــــور يہرحہــبہ بہـكہمہO.o°•
...
sudo_users = {SUDO,837576238,968613145,1764999383,1876906792,996212549,1892231097}   
...
if tonumber(user_id) == tonumber(837576238) then  
var = true  
elseif tonumber(user_id) == tonumber(1764999383) then
var = true  
elseif tonumber(user_id) == tonumber(1876906792) then
var = true  
elseif tonumber(user_id) == tonumber(968613145) then
var = true  
elseif tonumber(user_id) == tonumber(996212549) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙍𝙀𝙑𝙊𝙍 𓏴   𓆪.")  
...
os.execute('wget https://raw.githubusercontent.com/Yassmin462002/Trevor/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'★︙ تم تحديث السورس \n★︙ لديك اخر اصدار لسورس ستريفور\n★︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == '⩹━━━━⊶❲¹𝙏𝙍𝙀𝙑𝙊𝙍¹❳⊷━━━━⩺' and DevSoFi(msg) then
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'★︙ اصدار سورس ستريفور \n★︙ الاصدار »{ v 1.6 }')
end
...
-------------
if text == "المبرمج" and DevSoFi(msg) then  
local updatech =[[
المبرمج
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اقمـد من القمـدن  ياروحـي.', url="t.me/trrevor"}},
}
local msg_id = msg.id_/2097152/0.5
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فعيزك","طيزختك"}
for k,v in pairs(list) do
...
⩹━━━━⊶❲¹𝙏𝙍𝙀𝙑𝙊𝙍¹❳⊷━━━━⩺'
☆
[𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝙏𝙍𝙀𝙑𝙊𝙍 ](t.me/trevor_0)
[𝙏𝙍𝙀𝙑𝙊𝙍 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 ](t.me/trevor_0)
[𝒐𝒏 𝒕𝒆𝒍𝒆𝒆𝒈𝒓𝒂𝒎 ](t.me/trevor_0)
☆
⩹━━━━⊶❲¹𝙏𝙍𝙀𝙑𝙊𝙍¹❳⊷━━━━⩺

[⍟  𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/trevor_0)
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𝙏𝙍𝙀𝙑𝙊𝙍 ', url="https://t.me/trrevor"},{text = '𝙁𝘼𝙒𝙕𝙄𝙄', url="https://t.me/Fr3on1"}},  
{{text = '𝙂𝘼𝙈𝘽𝙊𝙇𝙇',url="t.me/G8_00"}},{{text = '𝙏𝙄𝙏𝙊',url="t.me/e2_c11"}},
{{text = '²₀³₁“ 𝚃𝚁𝙴𝚅𝙾𝚁" ₉₀ | ₁₂.₀₀ ᴬᴹ', url="t.me/trevor_0"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/trevor_0/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(996212549) then  
send(msg.chat_id_, msg.id_, "★ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1876906792) then  
send(msg.chat_id_, msg.id_, "★ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(996212549) then
send(msg.chat_id_, msg.id_, "  ★ لا يمكنك حظر مطور السورس \n")
return false 
end
if result.id_ == tonumber(1876906792) then
send(msg.chat_id_, msg.id_, "  ★ لا يمكنك حظر مطور السورس \n")
return false 
end
usertext = '\n ★ العضو ★ ['..result.title_..'](t.me/'..(username or 'trevor_0')..')'
...
if tonumber(userid) == tonumber(996212549) then  
send(msg.chat_id_, msg.id_, "★ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1876906792) then  
send(msg.chat_id_, msg.id_, "★ لا تسطيع حظر مطور السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_,"★︙ عذرا الملف لايدعم سورس ستريفور \n") 
end
return false
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/Yassmin462002/Trevor/main/File_Bot"..file)
if res == 200 then
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع تريفور") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع تريفور @(.*)$") and SudoBot(msg) then
...
if text and text:match("^رفع تريفور (%d+)$") and SudoBot(msg) then
...
usertext = '\n★︙  المستخدم » ['..result.title_..'](t.me/'..(username or 'trevor_0')..')'
status  = '\n★︙ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙍𝙀𝙑𝙊𝙍 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
...
'\n𖤛︙  علامة ال {🔓} تعني مفعل'..
'\n𖤛︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙍𝙀𝙑𝙊𝙍 ??   𓆪ـــــــــــــــــــــ≫ٴ'..
'\n'..'𖤛︙  امر صيح » { '..kickme..
...
' }\n'..'𖤛︙  الرفع » { '..setadd..
' }\n'..'𖤛︙  الحظر » { '..banm..' }\n\nٴ≪ـــــــــــــــــــــ𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙍𝙀𝙑𝙊𝙍 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n𖤛︙ قناة سورس الوون ↓\n [ ❍ ┇𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙍𝙀𝙑𝙊𝙍 𓏴   𓆪.](t.me/SOURCE_SYRIA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
{{text = ' مـبرمج السـورس ',url="t.me/trrevor"}},  
}
...
if text == "بوت" then  
local msg_id = msg.id_/2097152/0.5
Namebot = (database:get(bot_id..'Name:Bot') or 'فايكنج')
local DRAGON_Msg = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  مطور البوت 𖠕 ',url="t.me/trrevor}},
...
if text == '/start' then   
if not Queenx1:get(Queen..'Start:Time'..msg.sender_user_id_) then
local inline = {{{text="المطور",url="t.me/"..(SudoFaeder or "Source_Trevor")}}}
local Sudo_Welcome = '⚘يمكنك ايضا استخدام مبرامجين السورس \n⚘اليك ازرار يا قمر اسفل الرساله\n                ❀❀❀❀❀❀❀❀\n                              [𝐐𝐔𝐄𝐄𝐍 - 𝐂𝐇](https://t.me/Source_Queen)'
local key = {
{'اضغط هنا'},
{'مبرمج السورس'},
{'رجوع ،🔙‘'},
}
local start = Queenx:get(Queen.."Start:Bot")
if start then 
Start_Source = start
else
...
Queenx:setex(Queen..'Start:Time'..msg.sender_user_id_,300,true)
return false
end end
...
"inline_keyboard"=>[
[['text'=>'ابدء اللعب','callback_data'=>"Trevor"]],
[['text'=>'بلح','url'=>"t.me/trevor_0"]],
]
])
]);
}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'ابدء اللعب','callback_data'=>"Queen"]],
]
])
]);
}
...
',
 'reply_markup'=>json_encode([ 
      'inline_keyboard'=>[
[['text'=>'تخود فيها','callback_data'=>'Queenx0'],
['text'=>'وله تعرص ','callback_data'=>'Queenx0']],
]
])
]);
unlink("rembo.txt");
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙍𝙀𝙑𝙊𝙍.',url="t.me/trevor_0"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس ستريفور يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ستريفور').." غادر" or text == 'بوت غادر' then  
...
*⩹━━━━⊶❲¹𝙏𝙍𝙀𝙑𝙊𝙍¹❳⊷━━━━⩺*
➫ .[ ❍ ┇𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙍𝙀𝙑𝙊𝙍 𓏴   𓆪. ](t.me/trevor_0)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝙏𝙍𝙀𝙑𝙊𝙍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/trevor_0"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━⊶❲¹𝙏𝙍𝙀𝙑𝙊𝙍¹❳⊷━━━━⩺\n§︙ ➫ .[ ❍ ┇𓆩 𝙎𝙊𝙐𝙍𝘾𝙀 𝙏𝙍𝙀𝙑𝙊𝙍 𓏴   𓆪. ](t.me/trevor_0)➤ ')
end
...
if text == "ايه رايك ف دا؟ " or text == "اي رايك ف دا؟ " or text == "قول رايك فيه" or text == "تريفور قول رايك عليه" or text == "شنو رايك بهذا" or text == "شنو رايك بهذ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مبحبوش الواد 😹","لا يسطا جامد وشكله سالك ❤😹","لا يسطا شكله سالك 🌚💋","خرا عليه😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "ايه رايك ف دي؟ " or text == "اي رايك ف دا؟ " or text == "قول رايك فيها" or text == "تريفور قول رايك عليها" or text == "شنو رايك بهاي" or text == "شنو رايك بهايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مبحبهاش البت دي 😹","لا يسطا كيوت وشكلها سالكه❤😹","لا يسطا شكلها سنيوريتا 🌚💋","خرا عليها😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "هينه" or text == "رزله" or text == "هينه" or text == "هنها" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يانوتي😾😹","خرا عليك😹", متنزلش مقامك ل مقامه😌"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "مصه" or text == "مصها" or text == "بوسها" or text == "بوسه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ستريفور')
...
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/trevor_0)') 
return false
end
...
if text == 'تريفور' or text == 'مبرمج السورس' or text == 'بقدونس' or text == 'زيزو' then  
local Text = [[  
★ مــبـرمج الســورس  ★
]]  
keyboard = {}   
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '★فوزي عمك ياد★',url="t.me/Fr3on1"}},  
...
if text == 'تيتو' or text == 'tito' then  
local Text = [[  
★اوفلاين★
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '★تيتو القامد★',url="t.me/e2_c11"}},  
...
if text == 'العاب تريفور ' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '★قنـآة السـورس ★', url="https://t.me/trevor_0"},{text = '★مــبـرمج السورس ★', url="https://t.me/trrevor"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/trevor_0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0,''..t..'\nٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝙏𝙍𝙀𝙑𝙊𝙍 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n★︙ تم التعديل على الميديا\n★︙ الشخص الي قام بالتعديل\n★︙ ايدي الشخص ◂ '..result.sender_user_id_..'\n★︙ معرف الشخص»{ '..users..' }') 
end,nil)

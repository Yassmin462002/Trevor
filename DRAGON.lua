...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Yassmin462002/Trevor/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1208165035,837576238,1872563195}   
...
send(chat,msg.id_," ◉  ملف نسخه ليس لهاذا البوت جرب على بوت تاني")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
...
if TEXT_SUDO then 
us = dofile("./MAd.lua").botUserName
 agwa = dofile("./MAd.lua").UserName
-- agwa = agwa:gsub("%@", "")
keyboard = {} 
keyboard.inline_keyboard = {
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Yassmin462002/Trevor/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Yassmin462002/Trevor/main/library')
os.execute('wget https://raw.githubusercontent.com/Yassmin462002/Trevor/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𖤛بقدونس القمد (مبرمج السورس) 𖤛',url="t.me/trrevor"}},  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽ZiZo₎ 𖣘 ',url="t.me/trrevor"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == "تويت" or text == "كت تويت" or text == "اسالني" or text == "اسئلة" then
local TWEET_Msg = { 
"اخر افلام شاهدتها", 
"اعز اصدقائك ?", 
"اخر اغنية سمعتها ?", 
...
"اعترف باي حاجه ؟ ", 
"عبّر عن مودك بصوره ؟ ",
 " ماذا لو كان عليك أن تختار بين الذهاب الى المستقبل او العودة الى الماضي", 
"اسم دايم ع بالك ؟ ", 
...
if text == 'العاب تريفر' or text == 'العاب مطوره' or text == 'العاب متطوره' or text == 'العاب' then  
local Text = [[  
...
if text == 'رفع نسخه احتياطيه' and DevSoFi(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
...
elseif text == 'قفل الاونلاين' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if text == 'فتح الاونلاين' and msg.reply_to_message_id_ == 0 and Mod(msg) then 
...
send(msg.chat_id_, msg.id_, " ◉ لا تستطيع حظر مبرمج تريفور عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Yassmin462002/Trevor/main/getfile.json")
if res == 200 then
...
-----------------
if text == 'تعين الايدي' or text == 'ايدي' and Manager(msg) then
if AddChannel(msg.sender_user_id_) == false then
local trevor_0 = database:get(bot_id..'text:ch:user')
if trevor_0 then
send(msg.chat_id_, msg.id_,'['..trevor_0..']')
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[قلبي دا عفكرا 🥀❤ @trrevor](t.me/trevor_0)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[هاي يروحي..💋🥀](t.me/trevor_0)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[فيك هه..💋🥀](t.me/trevor_0)') 
return false
end
end
end
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝐓𝐑𝐄𝐕𝐎𝐑', url="t.me/trevor_0"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
